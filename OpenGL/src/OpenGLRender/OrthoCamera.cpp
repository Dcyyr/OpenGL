...
OrthoCamera::OrthoCamera(const glm::vec3& position, const glm::vec3& up, float yaw, float pitch)
...
void OrthoCamera::CameraInput(CameraMoveDirection direction, float ts)
{
...
void OrthoCamera::MouseMovement(float xoffset, float yoffset, bool constrainPitch)
{
...
void OrthoCamera::MouseScroll(float yoffset)
{
	m_Zoom -= yoffset;
